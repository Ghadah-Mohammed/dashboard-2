    ...
    <div className="login">
      ...
      <Form  onSubmit={login} className="loginForm">
        ...
        <Form.Group as={Row} className="mb-1" >
          <Form.Label column md="3" width="10px">Password</Form.Label>
          {/* <Col md="6"> */}
        ...
        <Form.Group as={Row} className="my-3"className="loginicon">
          <Col md={{ span: 10, offset: 2 }}>
            <Button type="submit" className="loginAdmin" style={{marginTop:"0px",backgroundColor:"rgba(14, 15, 26, 0.87)",border:"none"}} >Login<FiLogIn/></Button>
          </Col>
        </Form.Group>
      </Form>
    </div>
